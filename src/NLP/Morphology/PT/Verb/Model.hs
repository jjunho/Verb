...
import           NLP.Morphology.PT.Verb.Base (Citation, Gender,
                                              MoodTense (IFPR, IFUT, IIPF, INF, IPRS),
                                              Number, PersonNumber,
                                              Root (Root, root), RootType (Irr),
                                              ThematicVowel (E), gen, mkRoot,
                                              mkThematicVowel, mta, nullForm,
                                              num, pns, tv)
